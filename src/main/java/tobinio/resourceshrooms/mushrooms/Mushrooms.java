...
public class Mushrooms {
    ...
    public static Mushroom register(String displayName) {
        ...
        Item spores = ModItems.register(new AliasedBlockItem(block, new Item.Settings()), "%s_mushroom_spores".formatted(name));
        Item head = ModItems.register(new Item(new Item.Settings()), "%s_mushroom_head".formatted(name));
        Item blockItem = ModItems.register(new Item(new Item.Settings()), "%s_mushroom".formatted(name));
